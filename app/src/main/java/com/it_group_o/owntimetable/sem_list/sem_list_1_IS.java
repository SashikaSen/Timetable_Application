...
import com.it_group_o.owntimetable.year_IS;
import com.it_group_o.owntimetable.sem_list.subject_list_IS.*;

public class sem_list_1_IS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sem_list1_is);

        ly_sem = findViewById(R.id.sem_list_is_1);
        ...
        ly_sem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    Intent intent = new Intent(sem_list_1_IS.this, sub_1_1_IS.class);
                    startActivity(intent);
                } else if (position == 1) {
                    Intent intent = new Intent(sem_list_1_IS.this, sub_1_2_IS.class);
                    startActivity(intent);
                }
            }
