...
public class sem_list_3_IS extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem_list3_is);

        ListView ly_sem;
        String sem_list_1 [] = {"Semester 1", "Semester 2" };

        ly_sem = findViewById(R.id.sem_list_is_3);
        ...
        ly_sem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    Intent intent = new Intent(sem_list_3_IS.this, sub_3_1_IS.class);
                    startActivity(intent);
                } else if (position == 1) {
                    Intent intent = new Intent(sem_list_3_IS.this, sub_3_2_IS.class);
                    startActivity(intent);
                }
            }
