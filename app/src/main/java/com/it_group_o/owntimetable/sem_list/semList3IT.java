...
public class semList3IT extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem_list3_it);
        ...
        ly_sem = findViewById(R.id.sem_list_it_3);
        ...
        ly_sem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    Intent intent = new Intent(semList3IT.this, sub_3_1_IT.class);
                    startActivity(intent);
                } else if (position == 1) {
                    Intent intent = new Intent(semList3IT.this, sub_3_2_IT.class);
                    startActivity(intent);
                }
            }
